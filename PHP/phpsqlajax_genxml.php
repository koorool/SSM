...
//int mysql_errno([ resource $link_identifier = NULL ] );//if (!$connection) {  die('Not connected : ' . mysql_error());} //or die 

// Set the active MySQL database

$db_selected = mysql_select_db($database) or die ("Не могу соединиться с MySQLI.");//, $connection);
/*if (!$db_selected) {
